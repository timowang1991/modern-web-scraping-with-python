...
class EbooksSpider(scrapy.Spider):
    ...
    start_urls = ['https://openlibrary.org/subjects/picture_books.json?limit=100']
    ...
    def parse(self, response):
        ...
        yield scrapy.Request(
            url=f'https://openlibrary.org/subjects/picture_books.json?limit=100&offset={self.offset}',
            callback=self.parse
        )
